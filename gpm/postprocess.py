...
# add variable column
df['variable'] = 'precipitationCal'
# potentially add a list of all variables, or at least significant ones
# df['variable'] = ('precipitationCali', 'IRprecipitation', 'HQprecipitation','precipitationUncal')
